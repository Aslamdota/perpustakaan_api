                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="row g-3 needs-validation" action="{{ route('borrowings.confirm', $item->id) }}" method="post" novalidate="">
                                    @csrf
                                    <div class="col-md-6">
                                        <label for="bsValidation1" class="form-label">Tanggal Dikembalikan</label>
                                        <input type="date" class="form-control" id="bsValidation1" placeholder="" required="" name="due_date" required min="{{ date('Y-m-d') }}">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" id="bsValidation13" placeholder="Address ..." name="noted" rows="3" required=""></textarea>
                ...
                <div class="modal fade modal-center" id="formTolak" tabindex="-1" aria-labelledby="formTolakLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="row g-3 needs-validation" novalidate="" action="{{ route('borrowings.reject', $item->id) }}" method="post">
                                @csrf
                                    <div class="col-md-12">
                                        <label for="bsValidation13" class="form-label">Alasan</label>
                                        <textarea class="form-control" id="bsValidation13" placeholder="Masukan Alasan ..." name="noted" rows="3" required=""></textarea>
                                        <div class="invalid-feedback">
                                            Please enter a valid address.
                                        </div>
                                    </div>
